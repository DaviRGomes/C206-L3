...
public class Arquivo {
    ...
    public void escrever(Funcionario func){
        ...
        try{
            ...
            os = new FileOutputStream("C:\\Users\\Davi  Gay\\Desktop\\DaviRosaGomes_HenriqueRodriguesMendonça 1/pacode.txt", true);
    ...
    public ArrayList<Funcionario> ler(){
        ...
        try{
            ...
            is = new FileInputStream("C:\\Users\\Davi  Gay\\Desktop\\DaviRosaGomes_HenriqueRodriguesMendonça 1/pacode.txt");
    ...
    public void remover(Funcionario func) {
        ...
        try {
            os = new FileOutputStream("C:\\Users\\Davi  Gay\\Desktop\\DaviRosaGomes_HenriqueRodriguesMendonça 1/pacode.txt", false); // Sobrescreve o arquivo
            osw = new OutputStreamWriter(os);
            bw = new BufferedWriter(osw);
