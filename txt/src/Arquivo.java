...
public class Arquivo {
    ...
    public void escrever(Funcionario func){
        ...
        try{
            ...
            os = new FileOutputStream("C:\\Users\\Davi  Gay\\Desktop\\DaviRosaGomes_HenriqueRodriguesMendonça 1/saida.txt", true);
    ...
    public ArrayList<Funcionario> ler(){
        ...
        try{
            ...
            is = new FileInputStream("C:\\Users\\Davi  Gay\\Desktop\\DaviRosaGomes_HenriqueRodriguesMendonça 1/saida.txt");
            ...
            while(linhaLer != null){
                ...
                if(linhaLer.contains("sedasdasd")){ // se conter funcionario, iremos ler as informações
